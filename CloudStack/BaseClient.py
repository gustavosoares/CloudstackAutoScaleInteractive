...
class BaseClient(object):
    ...
    def request(self, command, args):
        ...
        if propertyResponse == 'createautoscalevmprofileresponse':
            propertyResponse = 'autoscalevmprofileresponse'
        if propertyResponse == 'createautoscalevmgroupresponse':
            propertyResponse = 'autoscalevmgroupresponse'
